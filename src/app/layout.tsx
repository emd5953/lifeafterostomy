                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                  <div className="md:col-span-2">
                    ...
                    <p className="text-emerald-100 max-w-md mb-6">
                      Supporting you through every step of your ostomy journey
                      with quality care kits, educational resources, and
                      community support.
                    </p>
                  ...
                  <div>
                    ...
                    <h4 className="text-lg font-semibold mb-4 mt-6 text-white">
                      Shop
                    </h4>
                    <ul className="space-y-3 text-emerald-100">
                      <li>
